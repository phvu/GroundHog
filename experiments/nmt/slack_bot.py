...
def prototype_encdec_state_slack_bot():
    """This prototype is the configuration used to train the RNNenc-30 model from the paper
    'Neural Machine Translation by Jointly Learning to Align and Translate' """

    state = prototype_state()

    state['target'] = ["/Users/vupham/data/slack_bot/out/binarized_text.out.shuf.h5"]
    state['source'] = ["/Users/vupham/data/slack_bot/in/binarized_text.in.shuf.h5"]
    state['indx_word'] = "/Users/vupham/data/slack_bot/in/ivocab.in.pkl"
    state['indx_word_target'] = "/Users/vupham/data/slack_bot/out/ivocab.out.pkl"
    state['word_indx'] = "/Users/vupham/data/slack_bot/in/vocab.in.pkl"
    state['word_indx_trgt'] = "/Users/vupham/data/slack_bot/out/vocab.out.pkl"
